		...
		<div class="grid grid-cols-1 items-center md:grid-cols-2">
			...
			>
				...
				>
					...
					<p class="text-3xl font-bold text-blue-900 underline">
						avaluosinmobiliariosqueretaro@gmail.com
					</p>
				</div>
			</div>
			...
			<div class="col-start-1 md:row-start-1 mt-20 overflow-hidden">
				...
				<div class="-translate-y-[460px] pl-20">
					...
					<h3
						id="inmob"
						class="opacity-0 ml-10 mt-10 md:mb-8 text-[clamp(1rem,8vmin,10rem)] font-bold leading-none tracking-tighter text-nowrap transform"
					>
						<span class="block text-blue-700 -mt-[.6em]">{slice.primary.subtitle}</span>
					</h3>
					<span
						id="city"
						class="opacity-0 ml-[2.5em] block bg-gradient-to-tr -mt-[1.2em] text-[clamp(1rem,10vmin,12rem)] from-gray-800 via-gray-600 to-gray-400 bg-clip-text text-transparent text-4xl font-bold uppercase tracking-[.2em] md:text-4xl opacity-0.5 transform"
					>
						{slice.primary.city}
					</span>
				</div>
